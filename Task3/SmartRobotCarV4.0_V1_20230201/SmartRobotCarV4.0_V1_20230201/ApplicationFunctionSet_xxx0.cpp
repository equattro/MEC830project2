...
void ApplicationFunctionSet::ApplicationFunctionSet_Obstacle(void)
{
  ...
  if (Application_SmartRobotCarxxx0.Functional_Mode == ObstacleAvoidance_mode)
  {
    ...
    if (function_xxx(get_Distance, 0, 25))
    {
      ApplicationFunctionSet_SmartRobotCarMotionControl(stop_it, 0);
      ...
      currentangle = mpu6050.getAngleZ();
      Serial.println(currentangle);
      while(currentangle <= 57 || currentangle >= 62)
      {
        if (currentangle < 57)
        {
          ApplicationFunctionSet_SmartRobotCarMotionControl(Left, 45);
          delay_xxx(25);
        }
        mpu6050.update();
        delay_xxx(25);
        ...
        if (currentangle > 62)
        {
          ApplicationFunctionSet_SmartRobotCarMotionControl(Right, 35);
          delay_xxx(25);
        }
        mpu6050.update();
        delay_xxx(25);
    ...
    while(currentangle >= -90 || currentangle <= -95)
      {
        if (currentangle > -90)
        {
        ...
        if (currentangle < -95)
        {
          ApplicationFunctionSet_SmartRobotCarMotionControl(Left, 35);
          delay_xxx(25);
    ...
    while(currentangle >= -25 || currentangle <= -30)
      {
        if (currentangle > -25)
        {
          ApplicationFunctionSet_SmartRobotCarMotionControl(Right, 35);
