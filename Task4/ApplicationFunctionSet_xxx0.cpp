...
static void ApplicationFunctionSet_SmartRobotCarMotionControl(SmartRobotCarMotionControl direction, uint8_t is_speed)
{
  ...
  case R2: //right turn
  case R3: //right turn
    AppMotor.DeviceDriverSet_Motor_control(/*direction_A*/ direction_back, /*speed_A*/ speed*1.1,
                                           /*direction_B*/ direction_just, /*speed_B*/ speed*0.45, /*controlED*/ control_enable); //Motor control
    break;
